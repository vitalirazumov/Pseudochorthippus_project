...
#Reading in the data
CovarFile <- read.csv(file = "~/Bilsajuttuja/Gradu/Stats/Plots/DeNovoStats/PCA/DeNovo1e-2.covar", header = F, sep = "\t", dec = ".")
CovarFile <- CovarFile[1:98]
SampleIdentities <- read.table(file = "~/Bilsajuttuja/Gradu/Stats/Plots/TranscriptomeStats/PCA/plink_all98.clst", sep="\t", header=T);
